...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AestheticPredictorsConfigStorage.getInstance().setAestheticPredictorsConfig(Config.sharedConfig().getAestheticPredictorsConfig(), Config.sharedConfig().getActivePredictors());
